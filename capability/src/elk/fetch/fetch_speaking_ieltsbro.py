...
from elk.paths import (
    ...
    state_dir, db_path, index_path, structured_dir,
)
...
DB_PATH = db_path()
CACHE_DIR = state_dir() / "cache" / "ieltsbro"
SNAP_DIR = data_root() /  "structured" / "speaking" / "seasons"
...
def main() -> int:
    ...
    print(f"    {out.relative_to(repo_root())}  ({n} 条)")
