...
from elk.parse.parse_reading_access import (              # noqa: E402
    TYPE_RULES, detect_word_limit, clean_lines, dedupe_paragraphs,
)

RAW_DIR = data_root() /  "raw" / "reading" / "ielts-official"
OUT_DIR = data_root() /  "structured" / "reading" / "official" / "taskbank"
